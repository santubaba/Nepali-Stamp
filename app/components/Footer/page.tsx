...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="px-6 py-10 bg-brand-text md:px-12 lg:px-16"
    >
      {/* ================= MOBILE ================= */}
      <div className="flex flex-col md:hidden">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="footer-description leading-relaxed text-brand-bg/75 font-meta">
            A complete digital archive of Nepal&apos;s postal history from 1881
            to the present day.
          </p>

          {/* Language */}
          <div className="footer-language inline-flex overflow-hidden border rounded w-fit border-brand-bg h-9">
            <button
        ...
        {/* Navigation */}
        <div className="footer-nav grid grid-cols-2 border-b border-brand-bg/20">
          {/* Stamps & FDC */}
        ...
        {/* Follow */}
        <div className="footer-social flex flex-col gap-5">
        ...
        {/* Bottom */}
        <div className="footer-bottom flex flex-col gap-4 text-sm text-brand-bg/40 font-body">
      ...
      <div className="flex-col hidden gap-10 md:flex">
        {/* Top */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[1.2fr_2.5fr_.8fr] lg:grid-cols-[1.5fr_3fr_1fr] lg:gap-10">
          {/* Left */}
          <div className="flex flex-col gap-8">
            <div className="footer-brand flex items-center gap-3 text-lg font-semibold font-heading">
            ...
            <p className="footer-description leading-relaxed text-brand-bg/75 font-meta">
              ...
              the first 1881 issue to the present day.
            </p>
            ...
            <div className="footer-language inline-flex overflow-hidden border rounded w-fit border-brand-bg h-9">
              <button
                onClick={() => setLanguage("EN")}
                className={`px-3 font-body transition-colors ${
                  language === "EN"
                    ? "bg-[#2F2E2E] text-brand-bg"
                    : "text-brand-bg/80"
                }`}
          ...
          {/* Center Navigation */}
          <div className="footer-nav grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-10">
            {/* Stamps & FDCs */}
          ...
          {/* Right Social */}
          <div className="footer-social flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-px bg-brand-accent" />
        ...
        <div className="footer-bottom flex items-center justify-between">
          ...
          <button
            ...
            className="footer-top flex items-center justify-center gap-2 transition-colors border w-44 h-14 border-brand-bg/30 rounded-xl text-brand-bg/50 hover:text-brand-bg font-body"
          >
            <IconArrowUp size={16} />
            Back To Top
          </button>
